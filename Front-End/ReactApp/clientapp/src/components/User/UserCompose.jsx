...
const UserCompose=()=>{
const URL="http://localhost:3001/User/compose_message"
...
const [message,setMessage]=useState({sender_id:token_data, receiver_id:"",subject:"",text:""})
  ...
  const handleSubmit=async(e)=>{
   ...
   <form onSubmit={handleSubmit} method="post">
    <div className="mt-4" style={{backgroundColor:"gray",border:'8px solid #333', marginLeft:"400px",marginRight:"400px"}}>

            <div className="mb-3">
              <h1 className="text-center">User Compose Form</h1>
